...
|1.8（p.94）</br>図B|右上の吹き出し 誤：Pヘッダ 正：IPヘッダ（👉<a href="images/img1728028436.png"><img src="images/img1728028436.png" height="30"></a>）|
|3.2（p.168）|コマンド書式内 誤：nc -zw 正：nc -z**v**</br><small>（本文の記載が正しいです）</small>|
